...
@AnalyzerDef(name = "appAnalyzer", charFilters = { @CharFilterDef(factory = HTMLStripCharFilterFactory.class) }, tokenizer = @TokenizerDef(factory = StandardTokenizerFactory.class), filters = { @TokenFilterDef(factory = StandardFilterFactory.class), @TokenFilterDef(factory = StopFilterFactory.class), @TokenFilterDef(factory = PhoneticFilterFactory.class, params = { @Parameter(name = "encoder", value = "DoubleMetaphone") }),
...
public class App implements Serializable {
   ...
   */
  @Column
  @Fields({ @Field(store = Store.COMPRESS), @Field(name = "sorting_name", analyze = Analyze.NO) })
  @Boost(1.5f)
  private String              name;
